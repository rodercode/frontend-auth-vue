 ...
 * Date: 24e May
 * 
 * This file is a util file for generating and verifying server created JWT access tokens. Currently keys are only valid for a duration of 45 minutes and will throw errors if expired key is attempted to be used. Whilst this is a flaw in the current version the script can be modified to use a long term refresh token and a short term access token to avoid unnecessary re-authentications.
 */
